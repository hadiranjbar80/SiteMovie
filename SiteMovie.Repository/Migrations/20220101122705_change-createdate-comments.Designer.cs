...
namespace SiteMovie.Repository.Migrations
{
    ...
    [Migration("20220101122705_change-createdate-comments")]
    partial class changecreatedatecomments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiteMovie.Domain.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SiteMovie.Domain.Models.Payment", b =>
                {
                    b.HasOne("SiteMovie.Domain.Models.Subscription", "Subscription")
                        .WithOne("Payment")
                        .HasForeignKey("SiteMovie.Domain.Models.Payment", "SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
