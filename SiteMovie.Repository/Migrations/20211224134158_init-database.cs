        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieImage = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryToMovies", x => new { x.CategoryId, x.MovieId });
                    table.ForeignKey(
                        name: "FK_CategoryToMovies_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryToMovies_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    Attachment = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    LinkTitle = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    MoviesId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieLinks_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryToMovies_MoviesId",
                table: "CategoryToMovies",
                column: "MoviesId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieLinks_MoviesId",
                table: "MovieLinks",
                column: "MoviesId");
